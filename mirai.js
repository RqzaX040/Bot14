...
const ANSI_BACKGROUND_YELLOW = "\x1b[43m";
const ANSI_BACKGROUND_MAGENTA = "\x1b[45m";
const ANSI_BACKGROUND_RED = "\x1b[41m";
...
///////////////////////////////////////////////////
const infoText = '━━━━━━━━━━━━━━━[ LOADING FILE ]━━━━━━━━━━━━━━━';
const boldInfoText = styledText(infoText, ANSI_BOLD);
console.log(coloredText(boldInfoText, ANSI_COLOR_BLACK, ANSI_BACKGROUND_MAGENTA));
...
function onBot({ models }) {
  ...
  login(loginData, async (loginError, loginApiData) => {
    ...
    const infoText4 = '━━━━━━━━━━━━━━━━[ START FILE ]━━━━━━━━━━━━━━━━';
    const boldInfoText4 = styledText(infoText4, ANSI_BOLD);
    console.log(coloredText(boldInfoText4, ANSI_COLOR_BLACK, ANSI_BACKGROUND_YELLOW));
      ...
      function() {
        ...
        for (const command of listCommand) {
          try {
            ...
            console.err(` Code Lệnh ${(command)} Không Phù Hợp!`, "[ COMMAND ]");
          };
        }
      }(),
      function() {
        ...
        for (const ev of events) {
          try {
            ...
            logger.loader(global.getText('mirai', 'failLoadMoAdule', event.config.name, error), 'error');
          }
        }
      }()
    ...
    logger.loader(`Thời gian khởi động: ${prettyMilliseconds(Date.now() - global.client.timeStart)}`);
...
(async () => {
  try {
    try {
      ...
      logger('Kết nối thành công dữ liệu ANTI SETTING', '[ CONNECT ]');
    }
    catch (error) {
      global.client.loggedMongoose = false;
      logger('Không thể kết nối dữ liệu ANTI SETTING', '[ CONNECT ]');
      console.log(error);
    }
  ...
  const infoText2 = '━━━━━━━━━━━━━━━[ FCA LOADING ]━━━━━━━━━━━━━━━━';
  const boldInfoText2 = styledText(infoText2, ANSI_BOLD);
  console.log(coloredText(boldInfoText2, ANSI_COLOR_BLACK, ANSI_BACKGROUND_RED));
})()
